 ...
 * 출석 핵심 비즈니스 로직 서비스
 *
 * 의존성: AttendanceRepositoryInterface, AttendanceStreakRepositoryInterface,
 *         AttendanceStreakService, AttendanceRankService, AttendanceSettingsService
 */
class AttendanceService
{
    ...
    {
        return $this->attendanceRepository->getTodayList($perPage);
    }
    ...
    {
        return $this->settingsService->getFrontendSettings();
    }
    ...
    {
        return $this->attendanceRepository->getTodayCount();
    }
}
